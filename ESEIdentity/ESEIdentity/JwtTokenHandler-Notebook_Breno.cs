...
{
    public const string JWT_SECURITY__KEY = "faSLkdfpasolkdaASFNNppasS1234567890!@#$"; // 32 caracteres
    ...
    public AuthenticationResponse GenerateJwtToken(AuthenticationRequest authenticationRequest)
    {
        ...
        var tookenExpiryTimeStamp = DateTime.UtcNow.AddMinutes(JWT_TOKEN_VALIDITY);
        ...
        {
            UserName = user.Name,
            ExpiresIn = (int)tookenExpiryTimeStamp.Subtract(DateTime.UtcNow).TotalSeconds,
            JwtToken = token,
        };
    }
}
